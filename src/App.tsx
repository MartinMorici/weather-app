...
function App() {
  ...
  return (
    <main className='w-full'>
      {!weather && (
        <>
          <button className='text-xl' onClick={getCurrentLocation}>Get Weather In Your Location</button>
          <h2 className='my-6 font-bold text-2xl'>OR</h2>
        </>
      )}
      <select className='px-10 py-[0.6em] text-xl' onChange={handleSelectedCity}>
